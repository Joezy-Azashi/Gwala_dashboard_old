...
const DeletePartner = ({deleteLoading, setOpenDelete, onDeletePartner}) => {
    ...
    return (
        <DialogContent>
            ...
            <Typography variant='body2' color={"#FA3E3E"} textAlign={"center"}>{formatMessage({ id: "merchants.create.warningnotepartner" })}</Typography>
