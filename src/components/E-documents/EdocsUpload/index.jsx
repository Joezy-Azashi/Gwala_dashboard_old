...
import { File, SecondSection, FirstSection } from "./style";
...
const Basic = ({ file, setFile, form, setForm, accept }) => {
...
const EdocsUpload = ({
  ...
  return (
    <div>
      ...
      <Basic setFile={setFile} file={file} form={form} setForm={setForm} accept={accept} />
